...
class BalloonMgr():
    ...
    def start(self):
        ...
        for balloonNum in range(0, N_BALLOONS):
            # per assignment requirement, make sure that the first TWO balloons
            # to be instantiated are MegaBalloons instead of regular regular Balloons
            if balloonNum < 2:
                randomBalloonClass = MegaBalloon
            else:
